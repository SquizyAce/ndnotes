...
<div style="display: flex; align-items: center;">
  <svg v-if="iconName == 'login'" width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <svg v-if="iconName == 'close'" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M1 1L17 17M17 1L1 17" stroke="white" stroke-width="2" stroke-linecap="round"/>
  </svg>  

  <svg v-if="iconName == 'add'" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path id="Vector" d="M1 9H17M9 1L9 17" stroke="white" stroke-width="2" stroke-linecap="round"/>
  </svg>  

  <svg v-if="iconName == 'password'" width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g id="Group 2">
    <rect id="Rectangle 3" x="1" y="8.5" width="16" height="10" rx="2" stroke="#B1C909" stroke-width="2"/>
    <circle id="Ellipse 1" cx="9" cy="13.5" r="2" stroke="#B1C909" stroke-width="2"/>
    <path id="Rectangle 4" d="M4 4.5C4 2.84315 5.34315 1.5 7 1.5H11C12.6569 1.5 14 2.84315 14 4.5V8.5H4V4.5Z" stroke="#B1C909" stroke-width="2"/>
    </g>
  </svg>

  <svg v-if="iconName == 'email'" width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g id="Group 1">
    <rect id="Rectangle 2" x="1" y="1" width="16" height="14" rx="3" stroke="#B1C909" stroke-width="2"/>
    <path id="Vector 1" d="M4 5L7.75061 8.00049C8.48105 8.58484 9.51895 8.58484 10.2494 8.00049L14 5" stroke="#B1C909" stroke-width="2"/>
    </g>
  </svg>

  <svg v-if="iconName == 'eye'" width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g id="Group 3">
    <path id="Ellipse 2" d="M17 7C17 8.15478 16.2206 9.64926 14.7228 10.9006C13.2537 12.128 11.2258 13 9 13C6.77424 13 4.7463 12.128 3.27718 10.9006C1.77936 9.64926 1 8.15478 1 7C1 5.84522 1.77936 4.35074 3.27718 3.09941C4.7463 1.87204 6.77424 1 9 1C11.2258 1 13.2537 1.87204 14.7228 3.09941C16.2206 4.35074 17 5.84522 17 7Z" stroke="#B1C909" stroke-width="2"/>
    <circle id="Ellipse 3" cx="9" cy="7" r="3" stroke="#B1C909" stroke-width="2"/>
    </g>
  </svg>

  <svg v-if="iconName == 'uneye'" width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g id="Group 3">
    <path id="Ellipse 2" d="M17 8C17 9.15478 16.2206 10.6493 14.7228 11.9006C13.2537 13.128 11.2258 14 9 14C6.77424 14 4.7463 13.128 3.27718 11.9006C1.77936 10.6493 1 9.15478 1 8C1 6.84522 1.77936 5.35074 3.27718 4.09941C4.7463 2.87204 6.77424 2 9 2C11.2258 2 13.2537 2.87204 14.7228 4.09941C16.2206 5.35074 17 6.84522 17 8Z" stroke="#B1C909" stroke-width="2"/>
    <circle id="Ellipse 3" cx="9" cy="8" r="3" stroke="#B1C909" stroke-width="2"/>
    <path id="Vector 103" d="M2 1L16 15" stroke="#B1C909" stroke-width="2"/>
    </g>
  </svg>
